...
## Objectives
- Validate and analyze a security alert
- Correlate data across multiple log sources
- Perform enrichment using OSINT tools
...
- Determined whether the alert was a true or false positive.
- Provided actionable remediation steps.

## What I Learned
- How to structure a full SOC-style investigation
- How to correlate logs across multiple data sources
- How to enrich indicators using OSINT
